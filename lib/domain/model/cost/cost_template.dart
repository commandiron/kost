...
class InteriorCostTemplate extends CostTemplate {
  InteriorCostTemplate(
    ...
    enabledCostCategories = const [
      ...
      CostCategory(MainCategory.interiorJobs, JobCategory.kitchenCupboard, UnitPriceCategory.lacqueredKitchenCupboard),
      ...
      CostCategory(MainCategory.mechanicalJobs, JobCategory.elevation, UnitPriceCategory.elevation10Person10StopKone),

...
extension UnitPriceCategoryExtension on UnitPriceCategory {
  String get nameTr {
    return switch (this) {
      ...
      UnitPriceCategory.cementSliding => "Çimento Esaslı Sürme İzolasyon",
      ...
      UnitPriceCategory.shinyLacqueredKitchenCupboardAster => "Aster Marka Parlak Lake Mutfak Dolabı",
      UnitPriceCategory.matteLacqueredKitchenCupboardAster => "Aster Marka Mat Lake Mutfak Dolabı",
      ...
      UnitPriceCategory.paddleBoxBuiltInOvenCookTopDishwasherFranke => "Franke Ankastre Beyaz Eşya Seti",
